"""Random Forest model wrapper implementing BaseLipidModel."""
...
class RandomForestModel(BaseLipidModel):
    """
    ...
    save() serialises only self.model (the raw RandomForestClassifier).
    """
